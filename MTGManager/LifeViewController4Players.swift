...
class LifeViewController4Players: UIViewController{
    ...
    func handlePlusMinus(){
        ...
        plusBottomLeft.center.y = self.view.frame.height - self.view.frame.height/16
    ...
    func loadDividers(){
        ...
        let fullSideRect = CGRect(x: 0, y: (view.frame.height/2)-3.75, width: view.frame.width, height: 7.5)
